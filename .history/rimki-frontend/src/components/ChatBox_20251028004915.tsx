...
import { Card, Input, Button, Avatar, Space, message, App } from "antd";
import {
  RedditOutlined,
  SearchOutlined,
  SendOutlined,
...
const Chatbox: React.FC = () => {
  ...
  const handleSend = async () => {
    ...
    if (!isAuth) {
      ...
      message.warning("Vui lòng đăng nhập để gửi tin nhắn");
      notification.error({
        message: "ERROR",
        description: "Vui lòng đăng nhập để sử dụng tính năng!",
      });
      return;
    }
